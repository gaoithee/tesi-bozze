...
#SBATCH --output=slurm_outs/PEC-phimeini-base-hotpot.out
...
#variables
FILE_NAME=/u/dssc/scandu00/tesi-bozze/def/phi-mini/baseline/hotpot/PEC-base-phi-mini.py
