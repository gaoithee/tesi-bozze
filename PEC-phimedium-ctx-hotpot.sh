...
#SBATCH --output=slurm_outs/PEC-phimedium-ctx-bridge.out
...
#variables
FILE_NAME=/u/dssc/scandu00/tesi-bozze/def/phi-medium/ctx/bridge/PEC-ctx-phi-medium.py
