...
#SBATCH --mem=90G                             # <-- TODO adjust this
#SBATCH --time=04:00:00                       # <-- TODO adjust this
#SBATCH --output=slurm_outs/ultra-mega-bridge.out
...
#variables
FILE_NAME=/u/dssc/scandu00/tesi-bozze/PECoRe-bridge.py
