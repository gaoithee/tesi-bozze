...
#SBATCH --output=slurm_outs/PEC-phimedium-cot-hotpot.out
...
#variables
FILE_NAME=/u/dssc/scandu00/tesi-bozze/def/phi-medium/cot/hotpot/PEC-cot-phi-medium.py
