...
#SBATCH --output=slurm_outs/roberta-naive-medium.out
...
#variables
FILE_NAME=/u/dssc/scandu00/tesi-bozze/def/phi-medium/roberta/roberta-naive-v2.py
CMD="python3 -u"
