...
#SBATCH --mem=40G                             # <-- TODO adjust this
#SBATCH --time=04:00:00                       # <-- TODO adjust this
#SBATCH --output=slurm_outs/remake-medium-base-wikihop.out
...
#variables
FILE_NAME=/u/dssc/scandu00/tesi-bozze/def/phi-medium/baseline/wikihop/remake-base-phi-medium.py
