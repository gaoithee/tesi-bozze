...
#SBATCH --output=slurm_outs/wikihop-phimedium-cot.out
...
#variables
FILE_NAME=/u/dssc/scandu00/tesi-bozze/def/phi-medium/cot/cot-phimedium-wikihop-test.py
