...
#SBATCH --output=slurm_outs/base-phimedium-ctx-wikihop.out
...
#variables
FILE_NAME=/u/dssc/scandu00/tesi-bozze/def/phi-medium/baseline/baseline-phimedium-ctx-wikihop.py
