...
#SBATCH --output=slurm_outs/base-gemma9b-wikihop-ctx.out
...
#variables
FILE_NAME=/u/dssc/scandu00/tesi-bozze/def/gemma-2-9b-it/baseline/baseline-gemma-2-9b-it-ctx-wikihop.py
