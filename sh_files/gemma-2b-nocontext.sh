...
#SBATCH --output=slurm_outs/gemma-2b-nocontext.out
...
#variables
FILE_NAME=/u/dssc/scandu00/tesi-bozze/def/gemma-2-2b-it/no-context/nocontext-gemma-2b.py
