...
#SBATCH --output=slurm_outs/cot-nocontext-phimedium.out
...
#variables
FILE_NAME=/u/dssc/scandu00/tesi-bozze/def/phi-medium/pure-cot-nocontext/cot-nocontext-phi-medium.py
