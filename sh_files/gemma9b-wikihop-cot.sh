...
#SBATCH --output=slurm_outs/base-gemma9b-wikihop-cot.out
...
#variables
FILE_NAME=/u/dssc/scandu00/tesi-bozze/def/gemma-2-9b-it/cot/cot-gemma-2-9b-it-wikihop.py
