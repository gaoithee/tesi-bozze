...
#SBATCH --output=slurm_outs/phi-medium-nocontext.out
...
#variables
FILE_NAME=/u/dssc/scandu00/tesi-bozze/def/phi-medium/no-context/nocontext-phi-medium.py
