...
#SBATCH --output=slurm_outs/wikihop-llama3-cot.out
...
#variables
FILE_NAME=/u/dssc/scandu00/tesi-bozze/def/llama3-8b-instruct/ctx/baseline-llama3-wikihop-ctx.py
