...
#SBATCH --output=slurm_outs/llama3-instruct-base.out
...
#variables
FILE_NAME=/u/dssc/scandu00/tesi-bozze/def/llama3-8b-instruct/NORAG-baseline-llama3.py
