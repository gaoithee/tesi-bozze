...
#SBATCH --output=slurm_outs/hotpot-llama3-base-is.out
...
#variables
FILE_NAME=/u/dssc/scandu00/tesi-bozze/def/llama3-8b-instruct/baseline-is-llama3-hotpotqa.py
