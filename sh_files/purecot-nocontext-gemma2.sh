...
#SBATCH --output=slurm_outs/cot-nocontext-gemma2.out
...
#variables
FILE_NAME=/u/dssc/scandu00/tesi-bozze/def/gemma-2-2b-it/pure-cot-nocontext/nocontext-purecot-gemma2b.py
