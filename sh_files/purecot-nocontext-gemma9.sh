...
#SBATCH --output=slurm_outs/cot-nocontext-gemma9.out
...
#variables
FILE_NAME=/u/dssc/scandu00/tesi-bozze/def/gemma-2-9b-it/pure-cot-nocontext/nocontext-purecot-gemma9b.py
