...
#SBATCH --output=slurm_outs/wikihop-llama3-purecot-notsumm.out
...
#variables
FILE_NAME=/u/dssc/scandu00/tesi-bozze/def/llama3-8b-instruct/pure-cot/pure-cot-llama3-wikihop-notsum.py
