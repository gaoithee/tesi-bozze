...
#SBATCH --output=slurm_outs/gemma-9b-nocontext.out
...
#variables
FILE_NAME=/u/dssc/scandu00/tesi-bozze/def/gemma-2-9b-it/no-context/nocontext-gemma-9b.py
