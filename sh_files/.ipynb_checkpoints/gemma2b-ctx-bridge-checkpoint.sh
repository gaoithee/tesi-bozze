...
#SBATCH --output=slurm_outs/bridge-gemma2b-ctx.out
...
#variables
FILE_NAME=/u/dssc/scandu00/tesi-bozze/def/gemma-2-2b-it/baseline/baseline-ctx-gemma-2b-bridge.py
