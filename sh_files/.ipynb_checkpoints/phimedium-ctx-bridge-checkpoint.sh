...
#SBATCH --output=slurm_outs/bridge-phimed-ctx.out
...
#variables
FILE_NAME=/u/dssc/scandu00/tesi-bozze/def/phi-medium/baseline/baseline-ctx-phimedium-bridge.py
