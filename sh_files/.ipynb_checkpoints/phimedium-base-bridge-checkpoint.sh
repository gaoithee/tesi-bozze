...
#SBATCH --output=slurm_outs/bridge-phimedium-base.out
...
#variables
FILE_NAME=/u/dssc/scandu00/tesi-bozze/def/phi-medium/baseline/baseline-phimedium-bridge.py
