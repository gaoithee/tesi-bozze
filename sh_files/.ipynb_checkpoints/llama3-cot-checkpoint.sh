...
#SBATCH --output=slurm_outs/wikihop-cot-llama3-notsumm.out
...
#variables
FILE_NAME=/u/dssc/scandu00/tesi-bozze/def/llama3-8b-instruct/cot/cot-llama3-wikihop-notsum.py
