...
#SBATCH --output=slurm_outs/base-phimedium-wikihop-ctx.out
...
#variables
FILE_NAME=/u/dssc/scandu00/tesi-bozze/def/phi-medium/baseline/baseline-phimedium-wikihop-ctx.py
