...
#SBATCH --output=slurm_outs/base-gemma2b-wikihop-ctx.out
...
#variables
FILE_NAME=/u/dssc/scandu00/tesi-bozze/def/gemma-2-2b-it/baseline/baseline-gemma-2-2b-it-ctx-wikihop.py
