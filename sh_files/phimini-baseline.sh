...
#SBATCH --mem=100G                             # <-- TODO adjust this
#SBATCH --time=04:00:00                       # <-- TODO adjust this
#SBATCH --output=slurm_outs/phimini-base-128k.out
...
#variables
FILE_NAME=/u/dssc/scandu00/tesi-bozze/def/phi-mini/128k/baseline-phimini-wikihop-test.py
