...
#SBATCH --output=slurm_outs/gemma-2-2b-it-base-ctx.out
...
#variables
FILE_NAME=/u/dssc/scandu00/tesi-bozze/def/gemma-2-2b-it/baseline-gemma-2-2b-it-ctx.py
